...
Following data aggregation and record matching, we can create a simple species distribution model to examine how habitat suitability (predicted occurence) has changed through time.
...
panel(preds_stack, range = c(0, 1), fill_range = TRUE,
      fun = function() lines(conts, lwd = 1, col  ="#000000"),
      box = TRUE,
      background = "grey90",
      nc = 2,
