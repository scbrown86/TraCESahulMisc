...
The package constains a small vignette showing some of the functionality. It can be found [here](https://scbrown.github.io/TraCESahulMisc/docs/TraCESahulMisc_workflow.html)
